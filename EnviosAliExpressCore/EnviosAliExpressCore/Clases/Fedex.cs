...
namespace EnviosAliExpressCore.Clases
{
    public class Fedex : IEmpresa
    {
        ...
        public Fedex(IMediosTransporte medioTransporte, ICalculadorMargenUtilidadCosto CalculadorMargenUtilidadCosto, List<TiempoRepartoDTO> lstTiempoReparto, ParametrosDTO parametrosFinal)
        {
        ...
        {
            //var medioTransporte = mediosTransportes.Where(i => i.cTipoMedioTransporte == parametros.cMedioTransporte).FirstOrDefault();
