...
namespace EnviosAliExpressCore.Clases
{
    public class Estafeta : IEmpresa
    {
        ...
        public Estafeta(IMediosTransporte medioTransporte, ICalculadorMargenUtilidadCosto CalculadorMargenUtilidadCosto, List<TiempoRepartoDTO> lstTiempoReparto, ParametrosDTO parametrosFinal)
        {
        ...
        public string cEmpresa => "ESTAFETA";
